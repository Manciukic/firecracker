...
pub use {
    ...
    kvm_bindings::kvm_irq_routing_entry, kvm_bindings::kvm_mp_state as MpState,
    kvm_bindings::kvm_userspace_memory_region as MemoryRegion,
    kvm_bindings::kvm_vcpu_events as VcpuEvents, kvm_bindings::KVM_IRQ_ROUTING_IRQCHIP,
    kvm_ioctls::DeviceFd, kvm_ioctls::IoEventAddress, kvm_ioctls::VcpuExit,
};
