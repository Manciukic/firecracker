...
use crate::{devices::virtio::mem::VirtioMemError, utils::usize_to_u64, vstate::memory::GuestMemoryMmap};
...
impl Response {
    pub fn write(&self, mem: &GuestMemoryMmap, addr: GuestAddress) -> Result<usize, VirtioMemError> {
        ...
        match self.resp_type {
            ResponseType::State(state) => {
                ...
                mem.write_obj(
                    resp, 
                    addr
                        .checked_add(usize_to_u64(num_bytes))
