...
pub type GuestMemoryMmap = crate::vm_memory_vendored::GuestRegionCollection<GuestMemoryRegionExt>;
...
impl GuestMemoryRegion for GuestMemoryRegionExt {
    ...
    fn into_region_ext(regions: Vec<GuestRegionMmap>) -> GuestMemoryMmap {
        GuestMemoryMmap::from_regions(
            regions
                ...
                .map(|(region, slot)| GuestMemoryRegionExt::dram_from_mmap_region(region, slot))
                .collect(),
        )
        .unwrap()
    }
